            ...
            <div class="container-fluid content">
                ...
                <div class="row">
                    <div class="col-lg-4 col-12 mb-3">
                        <div class="card bg-light w-100 shadow-sm" style="border-color: #EF233C;">
                            ...
                            <div class="card-footer">
                                <a href="./viewdonor.php" class="card-link d-flex" style="text-decoration: none;">
                        ...
                        <div class="card bg-light w-100 shadow-sm" style="border-color: #EF233C;">
                            <div class="card-body" style="background-color: rgba(239, 35, 60, 0.5);">
                                <div class="bd-widgets justify-content-between align-items-center d-flex">
                                    ...
                                    <div class="bd-info align-items-center justify-content-center" style="margin-right: 1rem;">
                                        <h3 class="">050</h3>
                                        <h6>Registered blood</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer">
                                <a href="./bloodbank.php" class="card-link d-flex" style="text-decoration: none;">
                                    <span>View Details</span>
                                    <i class="fas fa-chevron-right d-flex align-items-center ms-auto justify-content-center"></i>
                                </a>
                            </div>
                    ...
                    <div class="col-lg-4 col-12 mb-3">
                        <div class="card bg-light w-100 shadow-sm" style="border-color: #EF233C;">
                            ...
                            <div class="card-footer">
                                <a href="./viewrequest.php" class="card-link d-flex" style="text-decoration: none;">
                                    <span>View Details</span>
                                    <i class="fas fa-chevron-right d-flex align-items-center ms-auto justify-content-center"></i>
                                </a>
                            </div>
                ...
                <div class="row pt-4">
                    <div class="col-md-6 d-flex">
                        <div class="card flex-fill">
                            <div class="card-header d-flex" style="background-color: transparent;">
                                <h5 class="card-title d-flex align-items-center">Blood Donors</h5>
                            </div>
                            <div class="card-body">
                                <table class="table table-responsive table-striped">
                                    <thead>
                                        <tr>
                                            <th>Name</th>
                                            <th class="text-center">Date Donored</th>
                    ...
                    <div class="col-md-6 d-flex col-12">
                        <div class="card flex-fill">
                            <div class="card-header d-flex" style="background-color: transparent;">
                                <h5 class="card-title d-flex align-items-center">Requests</h5>
                            </div>
                            <div class="card-body">
                                <table class="table table-responsive table-striped">
                                    <thead>
